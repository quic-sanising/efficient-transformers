...
# CPU vs vLLM CPU
output_file="$output_dir/test_qaic_sampler_random_sampling_gumbel__test_gpu_vs_qaic.txt"
rm $output_file
...
for batch_size in "${batch_sizes[@]}"; do
    for vocab_size in "${vocab_sizes[@]}"; do
        pytest_output=$(pytest --disable-warnings -s -v test_qaic_sampler_random_sampling_gumbel.py::test_gpu_vs_qaic \
