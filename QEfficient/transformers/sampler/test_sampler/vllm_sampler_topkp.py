...
def apply_top_k_top_p(
    ...
    if not no_top_k:
        ...
        logits_sort.masked_fill_(top_k_mask, torch.finfo(torch.float16).min)
    ...
    if not no_top_p:
        ...
        # at least one
        top_p_mask[:, -1] = False
        logits_sort.masked_fill_(top_p_mask, torch.finfo(torch.float16).min)
...
#     """
#     from QEfficient.transformers.sampler.vllm.vllm.utils import make_tensor_with_pad
